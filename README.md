...
Criar uma instância de FormaManager.
Adicionar várias formas com cores diferentes. Ao adicionar a mesma cor (por exemplo, "Vermelho") em diferentes posições ou tamanhos, o sistema deve reutilizar a instância existente de Cor.
Chamar o método apresentar() para exibir todas as formas adicionadas, mostrando como as cores estão sendo reutilizadas.
